...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/qwertium/tzechco-PlsDonateAutofarmBackup/main/old.lua'))()")
end
...
local spinToggle = otherTab:AddSwitch('Spin [1R$ = +1 speed]', function(bool)
	...
	if getgenv().settings.spinSet then
		...
		task.spawn(function()
			...
			if (root.Position - sppos).Magnitude > 0.5 or (root.Position - sppos).Magnitude < -0.5 then
